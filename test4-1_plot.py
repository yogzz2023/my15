...
for i, (r, az, el, mt) in enumerate(measurements):
    ...
    if i == 0:
        ...
        # Here, we'll assume the most likely measurement is the one closest to the predicted position
        # You can replace this with a more sophisticated association method if needed
...
plt.subplot(3, 1, 1)
plt.plot(time_list, r_list, label='r')
plt.xlabel('Time')
plt.ylabel('r')
plt.title('r vs Time')
plt.legend()
...
plt.subplot(3, 1, 2)
plt.plot(time_list, az_list, label='az')
plt.xlabel('Time')
plt.ylabel('az')
...
plt.subplot(3, 1, 3)
plt.plot(time_list, el_list, label='el')
plt.xlabel('Time')
plt.ylabel('el')
plt.title('el vs Time')
plt.legend()
