...
plt.subplot(3, 1, 1)
plt.plot(time_list, r_list ,label ='filtered range (code)',color='green')
plt.plot(filtered_values_csv[:,0], filtered_values_csv[:,1], label ='filtered range (track id 57)',color='red',linestyle = "--")
plt.xlabel('Time')
plt.ylabel('Range (r)')
...
plt.subplot(3, 1, 2)
plt.plot(time_list, az_list,label ='filtered range (code)', color='red')
plt.plot(filtered_values_csv[:,0], filtered_values_csv[:,2], label ='filtered azimuth (track id 57)')
plt.xlabel('Time')
...
plt.subplot(3, 1, 3)
plt.plot(time_list, el_list,label ='filtered range (code)', color='green')
plt.plot(filtered_values_csv[:,0], filtered_values_csv[:,3], label ='filtered elevation (track id 57)')
plt.xlabel('Time')
